...
filter_l = ["one_devil_horn", "unihorn", "two_horns1", "two_horns2", "bunny_ears1", "bunny_ears2", "bunny_ears3"]
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 20, 551, 111))
        ...
        self.filter_sel_box.setMinimumSize(QtCore.QSize(200, 0))
