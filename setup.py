#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe -i img_utils.py -i gen_ui3.py opencv_main.py -W setup.py
...
opencv_main = Target(
    ...
    script="opencv_main.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'opencv_main'
    # dest_base = "opencv_main",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"opencv_main.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="opencv_main", level="asInvoker")).encode("utf-8")),
